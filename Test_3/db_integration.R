...
df_integration <- subset(df_integration, select=-c(trial_num,  change_lane_finished, start_change_lane_on_left, start_change_lane_on_right, follow_enable, pass_finished))
...
write.csv(df_integration, file = "experiments_Inteligencia_Artificial.csv", row.names = FALSE)
